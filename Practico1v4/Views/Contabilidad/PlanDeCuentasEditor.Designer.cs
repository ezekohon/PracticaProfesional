...
{
	partial class PlanDeCuentasEditor
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Codigo Balance";
			// 
			// textBoxUsuario
			// 
			...
			this.Name = "PlanDeCuentasEditor";
			this.Text = "UsuariosEditor";
			this.Load += new System.EventHandler(this.PlanDeCuentasEditor_Load);
