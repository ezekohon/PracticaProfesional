				...
				if (tenant != null)
				{
					...
					using (var context2 = new VentasDBContext(Common.TenantData.tenant.ConnectionString))
					{
						...
						context2.Cuentas.AddOrUpdate(
							new Cuenta { Id = 1, Tipo = 0, Nombre = "Activo", CodigoBalance = "1", CodigoPadre = "0" },
							new Cuenta { Id = 2, Tipo = 0, Nombre = "Activo Corriente", CodigoBalance = "1.1", CodigoPadre = "1" },
							new Cuenta { Id = 3, Tipo = 0, Nombre = "Disponibilidades", CodigoBalance = "1.1.01", CodigoPadre = "1.1" },
							new Cuenta { Id = 4, Tipo = 1, Nombre = "Cajas", CodigoBalance = "1.1.01.01", CodigoPadre = "1.1.01" },
							new Cuenta { Id = 5, Tipo = 0, Nombre = "Bancos", CodigoBalance = "1.1.01.02", CodigoPadre = "1.1.01" },
							new Cuenta { Id = 6, Tipo = 1, Nombre = "Banco Pcia. Cta.Cte.", CodigoBalance = "1.1.01.02.01", CodigoPadre = "1.1.01.02" },
							new Cuenta { Id = 7, Tipo = 1, Nombre = "Banco Nacion Cta.Cte", CodigoBalance = "1.1.01.02.02", CodigoPadre = "1.1.01.02" },
							new Cuenta { Id = 8, Tipo = 0, Nombre = "Cuentas Por Cobrar", CodigoBalance = "1.1.02", CodigoPadre = "1.1" },
							new Cuenta { Id = 9, Tipo = 1, Nombre = "Deudores en Cta.Cte", CodigoBalance = "1.1.02.01", CodigoPadre = "1.1.02" },
							new Cuenta { Id = 10, Tipo = 1, Nombre = "Documentos a Cobrar", CodigoBalance = "1.1.02.02", CodigoPadre = "1.1.02" },
							new Cuenta { Id = 11, Tipo = 1, Nombre = "IVA Credito Fiscal", CodigoBalance = "1.1.02.03", CodigoPadre = "1.1.02" },
							new Cuenta { Id = 12, Tipo = 0, Nombre = "Bienes De Cambio", CodigoBalance = "1.1.03", CodigoPadre = "1.1" },
							new Cuenta { Id = 13, Tipo = 0, Nombre = "Inversiones", CodigoBalance = "1.1.04", CodigoPadre = "1.1" },
							new Cuenta { Id = 14, Tipo = 0, Nombre = "Activos No Corrientes", CodigoBalance = "1.2", CodigoPadre = "1" },
							new Cuenta { Id = 15, Tipo = 0, Nombre = "Bienes de Uso", CodigoBalance = "1.2.01", CodigoPadre = "1.2" },
							new Cuenta { Id = 16, Tipo = 0, Nombre = "Pasivo", CodigoBalance = "2", CodigoPadre = "0" },
							new Cuenta { Id = 17, Tipo = 1, Nombre = "Rodados", CodigoBalance = "1.2.01.01", CodigoPadre = "1.2.01" },
							new Cuenta { Id = 18, Tipo = 1, Nombre = "Muebles y utiles", CodigoBalance = "1.2.01.02", CodigoPadre = "1.2.01" },
							new Cuenta { Id = 19, Tipo = 0, Nombre = "Pasivo Corriente", CodigoBalance = "2.1", CodigoPadre = "0" },
							new Cuenta { Id = 20, Tipo = 0, Nombre = "Deudas", CodigoBalance = "2.1.01", CodigoPadre = "2.1" },
							new Cuenta { Id = 21, Tipo = 0, Nombre = "Deudas Comerciales", CodigoBalance = "2.1.01.01", CodigoPadre = "2.1.01" },
							new Cuenta { Id = 22, Tipo = 1, Nombre = "Proveedores", CodigoBalance = "2.1.01.01.01", CodigoPadre = "2.1.01.01" },
							new Cuenta { Id = 23, Tipo = 1, Nombre = "Obligaciones a Pagar", CodigoBalance = "2.1.01.01.02", CodigoPadre = "2.1.01.01" },
							new Cuenta { Id = 24, Tipo = 0, Nombre = "Deudas Fiscales", CodigoBalance = "2.1.01.02", CodigoPadre = "2.1.01" },
							new Cuenta { Id = 25, Tipo = 1, Nombre = "IVA Debito Fiscal", CodigoBalance = "2.1.01.02.01", CodigoPadre = "2.1.01.02" },
							new Cuenta { Id = 26, Tipo = 1, Nombre = "IVA Percepciones", CodigoBalance = "2.1.01.02.02", CodigoPadre = "2.1.01.02" },
							new Cuenta { Id = 27, Tipo = 1, Nombre = "Ingresos Brutos a Pagar", CodigoBalance = "2.1.01.02.03", CodigoPadre = "2.1.01" },
							new Cuenta { Id = 28, Tipo = 0, Nombre = "Deudas Previsionales", CodigoBalance = "2.1.01.03", CodigoPadre = "2.1.01" },
							new Cuenta { Id = 29, Tipo = 1, Nombre = "Sueldos a Pagar", CodigoBalance = "2.1.01.03.01", CodigoPadre = "2.1.01.03" },
							new Cuenta { Id = 30, Tipo = 1, Nombre = "Cargas Sociales a Pagar", CodigoBalance = "2.1.01.03.02", CodigoPadre = "2.1.01.03" },
							new Cuenta { Id = 31, Tipo = 0, Nombre = "Deudas Bancarias", CodigoBalance = "2.1.01.04", CodigoPadre = "2.1.01" },
							new Cuenta { Id = 32, Tipo = 0, Nombre = "Pasivo no Corriente", CodigoBalance = "2.2", CodigoPadre = "2" },
							new Cuenta { Id = 33, Tipo = 0, Nombre = "Patrimonio Neto", CodigoBalance = "3", CodigoPadre = "0" },
							new Cuenta { Id = 34, Tipo = 0, Nombre = "Capital", CodigoBalance = "3.1", CodigoPadre = "3" },
							new Cuenta { Id = 35, Tipo = 1, Nombre = "Capital Social", CodigoBalance = "3.1.01", CodigoPadre = "3.1" },
							new Cuenta { Id = 36, Tipo = 0, Nombre = "Reservas", CodigoBalance = "3.2", CodigoPadre = "3" },
							new Cuenta { Id = 37, Tipo = 0, Nombre = "Resultados Acumulados", CodigoBalance = "3.3", CodigoPadre = "3" },
							new Cuenta { Id = 38, Tipo = 1, Nombre = "Resultado Ejercicio Anterior", CodigoBalance = "3.3.01", CodigoPadre = "3.3" },
							new Cuenta { Id = 39, Tipo = 0, Nombre = "Resultado Positivo", CodigoBalance = "4", CodigoPadre = "0" },
							new Cuenta { Id = 40, Tipo = 0, Nombre = "Ingresos Ordinarios", CodigoBalance = "4.1", CodigoPadre = "4" },
							new Cuenta { Id = 41, Tipo = 1, Nombre = "Ventas", CodigoBalance = "4.1.01", CodigoPadre = "4.1" },
							new Cuenta { Id = 42, Tipo = 1, Nombre = "Intereses Obtenidos", CodigoBalance = "4.1.02", CodigoPadre = "4.1" },
							new Cuenta { Id = 43, Tipo = 1, Nombre = "Descuentos Obtenidos", CodigoBalance = "4.1.03", CodigoPadre = "4.1" },
							new Cuenta { Id = 44, Tipo = 0, Nombre = "Ingresos Extraordinarios", CodigoBalance = "4.2", CodigoPadre = "4" },
							new Cuenta { Id = 45, Tipo = 0, Nombre = "Resultado Negativo", CodigoBalance = "5", CodigoPadre = "0" },
							new Cuenta { Id = 46, Tipo = 0, Nombre = "Gastos de Comercializacion", CodigoBalance = "5.1", CodigoPadre = "5" },
							new Cuenta { Id = 47, Tipo = 1, Nombre = "Costo de Venta", CodigoBalance = "5.1.01", CodigoPadre = "5.1" },
							new Cuenta { Id = 48, Tipo = 0, Nombre = "Gastos Administrativos", CodigoBalance = "5.2", CodigoPadre = "5" },
							new Cuenta { Id = 49, Tipo = 1, Nombre = "Agua, luz y gas", CodigoBalance = "5.2.01", CodigoPadre = "5.2" },
							new Cuenta { Id = 50, Tipo = 1, Nombre = "Impuestos", CodigoBalance = "5.2.02", CodigoPadre = "5.2" },
							new Cuenta { Id = 51, Tipo = 1, Nombre = "Telefono", CodigoBalance = "5.2.03", CodigoPadre = "5.2" },
							new Cuenta { Id = 52, Tipo = 0, Nombre = "Gastos en Personal", CodigoBalance = "5.3", CodigoPadre = "5" },
							new Cuenta { Id = 53, Tipo = 1, Nombre = "Sueldos y Jornales", CodigoBalance = "5.3.01", CodigoPadre = "5.3" },
							new Cuenta { Id = 54, Tipo = 1, Nombre = "Cargas Sociales", CodigoBalance = "5.3.02", CodigoPadre = "5.3" },
							new Cuenta { Id = 55, Tipo = 0, Nombre = "Gastos Financieros", CodigoBalance = "5.4", CodigoPadre = "5" },
							new Cuenta { Id = 56, Tipo = 1, Nombre = "Intereses Cedidos", CodigoBalance = "5.4.01", CodigoPadre = "5.4" },
							new Cuenta { Id = 57, Tipo = 1, Nombre = "Descuentos Cedidos", CodigoBalance = "5.4.02", CodigoPadre = "5.4" },
							new Cuenta { Id = 58, Tipo = 1, Nombre = "Gastos Bancarios", CodigoBalance = "5.4.03", CodigoPadre = "5.4" },
							new Cuenta { Id = 59, Tipo = 0, Nombre = "Otros Gastos", CodigoBalance = "5.5", CodigoPadre = "5" }
							);
