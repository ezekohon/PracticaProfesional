namespace Practico1v4.Views.Login
{
	partial class OlvidoPassword
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Ingrese su nombre de usuario y mail, y se le enviará una contraseña temporal.";
			// 
			// label2
			// 
			...
			this.Name = "OlvidoPassword";
			this.Text = "OlvidoPassword";
